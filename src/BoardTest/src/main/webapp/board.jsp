                            ...
                            <tfoot>
								...
								<tr>
									...
									<td colspan="3" class="main-paging">
										...
										<c:otherwise>
											<li>
												<a href="board.do?type=board&cPage=${pvo.beginPage - 1 }">이전으로</a>
											</li>
										</c:otherwise>
										</c:choose>	
										...
										<c:otherwise>
											<li><a href="board.do?type=board&cPage=${pageNo }">${pageNo }</a></li>
										</c:otherwise>	
										</c:choose>
										</c:forEach>
										...
										<c:if test="${pvo.endPage < pvo.totalPage }">					
											<li><a href="board.do?type=board&cPage=${pvo.endPage + 1 }">다음으로</a></li>
										</c:if>
										<c:if test="${pvo.endPage >= pvo.totalPage }">					
